        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Evenement>().HasData(
              new Evenement
              {
                  ...
                  Date = new DateTime(10 / 12 / 1988),
                  HeureOuverture = new DateTime(2022, 12, 31, 9, 0, 0),
                  HeureFermeture = new DateTime(2022, 12, 31, 18, 0, 0),
                  Prix = 40,
              ...
              new Evenement
              {
                  ...
                  Date = new DateTime(10 / 06 / 2022),
                  HeureOuverture = new DateTime(2022, 12, 31, 9, 0, 0),
                  HeureFermeture = new DateTime(2022, 12, 31, 19, 0, 0),
                  Prix = 300,
                  Adresse = "40 rue de Evenement",
                  Categorie = "theatre",
                  Photo = "chemin/photo_evenement",
              ...
              new Evenement
              {
                  EvenementId = 3,
                  Nom = "Evenement Parc",
                  Date = new DateTime(01 / 02 / 2023),
                  HeureOuverture = new DateTime(2022, 12, 31, 10, 0, 0),
                  HeureFermeture = new DateTime(2022, 12, 31, 17, 0, 0),
                  Prix = 146,
                  Adresse = "40 rue de Evenement",
                  Categorie = "spectacle",
                  Photo = "chemin/photo_evenement",
